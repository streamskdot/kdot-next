...
interface ExoclickSkyscraperAdProps {
  className?: string
}

export function ExoclickSkyscraperAd({ className = '', onAdLoadError }: ExoclickSkyscraperAdProps & { onAdLoadError?: () => void }) {
  ...
  useEffect(() => {
    ...
    if (document.querySelector('script[src="https://a.magsrv.com/ad-provider.js"]')) {
      ...
      script.onerror = () => {
        console.log('Exoclick skyscraper script blocked by privacy protection')
        if (onAdLoadError) {
          onAdLoadError()
        }
      }
