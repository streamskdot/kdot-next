...
interface ExoclickVideoSliderAdProps {
  className?: string
}

export function ExoclickVideoSliderAd({ className = '', onAdLoadError }: ExoclickVideoSliderAdProps & { onAdLoadError?: () => void }) {
  ...
  useEffect(() => {
    ...
    if (document.querySelector('script[src="https://a.magsrv.com/ad-provider.js"]')) {
      ...
      script.onerror = () => {
        console.log('Exoclick video slider script blocked by privacy protection')
        if (onAdLoadError) {
          onAdLoadError()
        }
      }
